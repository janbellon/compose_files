...
openmetrics_allow_ips = { "127.0.0.1", "::1", "147.135.211.34" }
--openmetrics_allow_cidr = { "10.2.0.0/16" }

-- Push notificqtions
push_notifications_important_body = "New Message !"
push_max_errors = 16
push_max_devices = 5
push_max_hibernation_timeout = 259200
...
ssl = {
      key = "/etc/prosody/certs/nobell.fr.key";
      certificate = "/etc/prosody/certs/nobell.fr.crt";
      protocol = "tlsv1_1+";
}
...
--sql = { driver = "PostgreSQL", database = "jan_prosody", username = "jan_prosody_user", password = "WgvzBfPw2uD2TnruBGFm2Cx45ugTY5Ha", host = "10.34.0.10" }
...
turn_external_host = "turn.nobell.fr"

-- This secret must be set to the same value in both Prosody and the TURN server
turn_external_secret = "U2XwiS2PDJ5VHmkajrc3qh8iUZZ6h68U"
...
Component "muc.nobell.fr" "muc"
--- Store MUC messages in an archive and allow users to access it
modules_enabled = { "muc_mam" }

---Set up a file sharing component
Component "xmpp-upload.nobell.fr" "http_file_share"
http_file_share_expires_after = 180*24*60*60
